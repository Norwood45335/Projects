/*Norwood
*
*Description: Program to make use of chaining in a Hash Table. The impleme    ntation is done by calling a function from list.h. The test cases take speci    fic txt files as input and output the word count or a list of specific words     from the file if the program specifies. 
*
*/
