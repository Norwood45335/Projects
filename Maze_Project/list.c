/* Norwood
* 
* Description: Implementation of a circular doubly linked list. The inserti    on and deletion operations take place on both ends of the list. Manipulation     of pointers takes place as elements get added and removed. The radix workfl    ow will take a list of integers as input and sort those integers. The maze m    akes of pointer manipulation in the functions addFirst, removeFirst, and num    Items for the function of the maze program. 
*
*/
